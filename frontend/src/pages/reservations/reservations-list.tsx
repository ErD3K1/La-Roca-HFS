...
const ReservationsTablesPage = () => {
  ...
  const [filters] = useState([
          ...
          {label: 'ReservationDate', title: 'reservation_date', date: 'true'},

          {label: 'PickupLocation', title: 'pickup_location', type: 'enum', options: ['concierge','apartment','new_concierge']},
  ]);
  const addFilter = () => {
        const newItem = {
            id: uniqueId(),
    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox   className='mb-6' cardBoxClassName='flex flex-wrap'>
          <BaseButton className={'mr-3'} href={'/reservations/reservations-new'} color='info' label='New Item' />
          <BaseButton
              className={'mr-3'}
              color='info'
              label='Filter'
