...
const EditBoutiques = () => {
  ...
  const { boutiquesId } = router.query

  useEffect(() => {
    dispatch(fetch({ id: boutiquesId }))
  }, [boutiquesId])
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: boutiquesId, data }))
...
EditBoutiques.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
