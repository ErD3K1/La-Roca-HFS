  ...
  definition: {
    openapi: "3.0.0",
      info: {
        version: "1.0.0",
        title: "La Roca HFS",
        description: "La Roca HFS Online REST API for Testing and Prototyping application. You can perform all major operations with your entities - create, delete and etc.",
      },
    servers: [
      {
...
app.use('/api/bags', passport.authenticate('jwt', {session: false}), bagsRoutes);

app.use('/api/boutiques', passport.authenticate('jwt', {session: false}), boutiquesRoutes);
